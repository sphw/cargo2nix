...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cargo."0.58.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.58.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cab77eea837b09297f6ad70921e465d77b60eb10380505abc02bd6e66b653704"; };
    dependencies = {
      ...
      os_info = rustPackages."registry+https://github.com/rust-lang/crates.io-index".os_info."3.0.8" { inherit profileName; };
      ...
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.131" { inherit profileName; };
  ...
  "unknown".cargo2nix."0.11.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.51" { inherit profileName; };
      cargo = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo."0.58.0" { inherit profileName; };
      cargo_platform = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo-platform."0.1.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl."0.4.41" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.kernel.name == "darwin") then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.71" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.51+curl-7.80.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.23" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libgit2-sys."0.12.26+1.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libz_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libz-sys."1.1.3" { inherit profileName; };
      ${ if hostPlatform.isUnix then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.71" { inherit profileName; };
    };
    buildDependencies = {
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.72" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.23" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".os_info."3.0.8" = overridableMkRustCrate (profileName: rec {
    name = "os_info";
    version = "3.0.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e5501659840950e918d046ad97ebe9702cbb4ec0097e47dbd27abf7692223181"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "serde" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pest_generator."2.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.33" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.23" = overridableMkRustCrate (profileName: rec {
    name = "pkg-config";
    version = "0.3.23";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d1a3ea4f0dd7f1f3e512cf97bf100819aa547f36a6eccac8dbaae839eb92363e"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.33" = overridableMkRustCrate (profileName: rec {
    name = "proc-macro2";
    version = "1.0.33";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fb37d2df5df740e582f28f8560cf425f52bb267d872fe58358eadb554909f07a"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "proc-macro" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".serde."1.0.131" = overridableMkRustCrate (profileName: rec {
    name = "serde";
    version = "1.0.131";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b4ad69dfbd3e45369132cc64e6748c2d65cdfb001a2b1c232d128b4ad60561c1"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "derive" ]
      [ "serde_derive" ]
    ...
    dependencies = {
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.131" { profileName = "__noProfile"; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.131" = overridableMkRustCrate (profileName: rec {
    name = "serde_derive";
    version = "1.0.131";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b710a83c4e0dff6a3d511946b95274ad9ca9e5d3ae497b63fda866ac955358d2"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
